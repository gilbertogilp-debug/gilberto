...
export const AdminSidebar: React.FC = () => {
  ...
  return (
    <>
      {/* Mobile Top Header Bar for Admin View */}
      <div className="md:hidden sticky top-0 z-30 w-full bg-slate-950/90 backdrop-blur-xl border-b border-slate-800 px-4 py-3 flex items-center justify-between">
        <div 
        ...
        >
          ...
          <div>
            <span className="text-sm font-black text-white">Impulsio Admin</span>
            <span className="text-[10px] block font-bold text-purple-400 -mt-1 uppercase">Painel de Controle</span>
          </div>
        </div>

        <button
          onClick={switchRole}
          className="px-2.5 py-1 rounded-xl bg-blue-500/20 text-blue-400 border border-blue-500/30 text-[10px] font-extrabold flex items-center gap-1"
        >
        ...
        >
          ...
          <div>
            <span className="text-base font-extrabold text-white">
              Impulsio <span className="text-purple-400">Admin</span>
            </span>
